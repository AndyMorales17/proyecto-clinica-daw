...
=======
                <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#">Compras</a></li> 
                <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#">Clientes</a></li> 
                <li class="nav-item">
